<template>
    <v-chip-group active-class="primary--text">
        <v-chip v-for="item in features" :key="item" outlined class="text-caption" @click="filterByFeature(item)">
...
export default {
    ...
    data() {
        return {
            features: ['all', 'fast', 'oven', 'pot', 'stewingdish', 'grill', 'combo', 'toaster'],
        };
    },
