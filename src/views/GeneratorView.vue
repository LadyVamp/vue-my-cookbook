...
export default {
    ...
    methods: {
        ...
        sixServings() {
            ...
            let randomDish = filtered[Math.floor(Math.random() * filtered.length)].title;
            console.log('sixServings', filtered, randomDish);
        ...
        notFast() {
            ...
            let randomDish = filtered[Math.floor(Math.random() * filtered.length)].title;
            console.log('notFast', filtered, randomDish);
        ...
        fast4ServingsLunch() {
            ...
            let randomDish = filtered[Math.floor(Math.random() * filtered.length)].title;
            console.log('fast4ServingsLunch', filtered, randomDish);
        ...
        fast4ServingsDinner() {
            ...
            let randomDish = filtered[Math.floor(Math.random() * filtered.length)].title;
            console.log('fast4ServingsDinner', filtered, randomDish);
